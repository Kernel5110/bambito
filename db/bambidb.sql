CREATE DATABASE  IF NOT EXISTS `bambidb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bambidb`;
...
INSERT INTO `catproducto` VALUES (7,'Concha de vainilla','Pan dulce tradicional con cobertura de vainilla',10.00,47,'imagenes\\concha_vainilla.png','2025-12-31','Vainilla',0.16,'Disponible',1,1),(8,'Baguette rústica','Pan salado ideal para sándwiches',15.00,39,'imagenes\\baguette_rustico.png','2025-10-15',NULL,0.16,'Disponible',2,4),(9,'Pastel cumple Choco','Pastel de chocolate con velitas',250.00,0,'imagenes\\pastel_choco.png','2025-09-01','Chocolate',0.16,'Disponible',3,2),(10,'Pastel boda 3 pisos','Decorado con flores blancas',800.00,14,'imagenes\\pastel_boda.png','2025-12-25','Fresa',0.16,'Disponible',4,5),(11,'Galleta choco chip','Crujiente y dulce',5.00,95,'imagenes\\galleta_choco.png','2025-08-20','Chocolate',0.16,'Disponible',5,3),(12,'Galleta avena','Galletas saludables con avena y pasas',6.50,71,'imagenes\\galleta_avena.png','2025-08-22','Avena',0.16,'Disponible',6,6),(25,'Pan Francés','Pan tradicional francés',15.00,99,'imagenes\\pan_frances.png','2023-12-31','Salado',0.16,'Disponible',1,1),(26,'Pastel de vainilla','Pastel de chocolate con cobertura',150.00,48,'imagenes\\pastel_vainilla.png','2023-12-31','Chocolate',0.16,'Disponible',2,2),(33,'Bigote','Pan dulce en forma de bigote',8.00,16,'imagenes\\bigote.png','2025-05-10','vainilla',0.16,'Disponible',0,0),(34,'Bisquet','Pan suave tipo bisquet',9.00,20,'imagenes\\bisquet.png','2025-05-10','natural',0.16,'Disponible',0,0),(35,'Bolillo','Pan salado para acompañar comidas',2.50,1,'imagenes\\bolillo.png','2025-05-08','salado',0.16,'Disponible',0,0),(36,'Concha','Pan dulce con cubierta azucarada',7.00,10,'imagenes\\concha_choco.png','2025-05-09','chocolate',0.16,'Disponible',0,0),(37,'Croissant','Pan de hojaldre tipo francés',12.00,19,'imagenes\\croissant.png','2025-05-09','mantequilla',0.16,'Disponible',0,0),(38,'Cuernito','Pan con forma de cuerno',6.00,11,'imagenes\\cuerno.png','2025-05-10','vainilla',0.16,'Disponible',0,0),(39,'Cupcake','Pastelito individual decorado',10.00,15,'imagenes\\cupcake.png','2025-05-12','fresa',0.16,'Disponible',0,0),(40,'Dona','Pan frito con glaseado',8.50,15,'imagenes\\dona.png','2025-05-11','azúcar',0.16,'Disponible',0,0),(41,'EmpanadaPina','Empanada rellena de piña',7.50,10,'imagenes\\empanada.png','2025-05-10','piña',0.16,'Disponible',0,0),(42,'Focaccia','Pan italiano con hierbas',15.00,8,'imagenes\\focaccia.png','2025-05-12','romero',0.16,'Disponible',0,0),(43,'Galleta_Chocolate','Galleta con trozos de chocolate',5.00,20,'imagenes\\galleta_chocolate.png','2025-06-01','chocolate',0.16,'Disponible',0,0),(44,'Oreja','Pan de hojaldre con azúcar',6.00,14,'imagenes\\oreja.png','2025-05-10','azúcar',0.16,'Disponible',0,0),(45,'PanHamburguesa','Pan redondo para hamburguesas',4.00,12,'imagenes\\pan_hamburguesa.png','2025-05-09','natural',0.16,'Disponible',0,0),(46,'Polvoron','Pan seco que se deshace en la boca',3.50,10,'imagenes\\polvoron.png','2025-06-01','vainilla',0.16,'Disponible',0,0),(47,'Telera','Pan tradicional mexicano',3.00,10,'imagenes\\telera.png','2025-05-09','salado',0.16,'Disponible',0,0);
...
-- Dump completed on 2025-06-01 12:26:17
