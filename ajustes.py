...
class ajustes:
    ...
    def mostrar_formulario_nuevo_empleado(self):
        ...
        labels = [
            ...
            "NSS", "Correo", "Teléfono", "Padecimientos", "Calle", "Colonia", "CP", "Puesto", "Contraseña", "Fecha de Nacimiento (DD/MM/AAAA)"
        ]
    ...
    def dibujar_formulario_nuevo_empleado(self, surface):
        ...
        font_label = pygame.font.SysFont("Open Sans", int(0.027 * self.alto))
    ...
    def cargar_clientes(self):
        ...
        query = """
            SELECT Id_Cliente AS id, Nombre_Cliente AS nombre, Ap_Paterno_cliente AS ap_paterno,
                Ap_Materno_cleinte AS ap_materno, Telefono_cli AS telefono, Correo AS correo,
    ...
    def mostrar_formulario_nuevo_cliente(self):
        ...
        labels = [
            ...
            "RFC", "Calle", "Colonia", "CP", "Fecha de Nacimiento (DD/MM/AAAA)"
        ]
    ...
    def guardar_nuevo_proveedor(self):
        ...
        nombre, ap_paterno, ap_materno, razon_social, rfc, correo, telefono, fecha_nacimiento, direccion = valores
        ...
        rfc_valido, mensaje = self.validar_rfc(rfc, fecha_nacimiento)
        if not rfc_valido:
            self.formulario_proveedor_mensaje = mensaje
            return
        ...
        try:
            conexion.conectar()
            conexion.cursor.execute(insert, (nombre, ap_paterno, ap_materno, razon_social, rfc, correo, telefono, fecha_nacimiento, direccion))
            conexion.conn.commit()
    ...
    def mostrar_formulario_nuevo_proveedor(self):
        ...
        labels = [
            ...
            "Correo", "Teléfono", "Fecha de Nacimiento (DD/MM/AAAA)"
        ]
    ...
    def handle_event(self, event):
        ...
        Eventos manejados:
        - MOUSEBUTTONDOWN: Clics en botones y campos
